...
#ifndef __action_CB_H__
#define __action_CB_H__

#include <gtk/gtk.h>

void action_cancel_cb (GtkWidget * widget, gpointer data);
...
void action_browse_icon_cb (GtkWidget * widget, gpointer data);
#endif
