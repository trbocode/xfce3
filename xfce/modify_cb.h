...
void modify_browse_icon_cb (GtkWidget * widget, gpointer data);

void modify_remove_cb (GtkWidget * widget, gpointer data);

void modify_change_cb (GtkWidget * widget, gpointer data);

void modify_add_cb (GtkWidget * widget, gpointer data);
